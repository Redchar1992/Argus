        ...
        try:
            return await self.workflow.start(
                WorkflowStartRequest(
                    ...
                    targetChapterCount=message.target_chapter_count,
                    targetTotalWords=message.target_total_words,
                    chapterTargetWords=message.chapter_target_words,
                    viewpoint=message.viewpoint,
                    styleProfile=message.style_profile,
                ),
                on_update=on_update,
                operation_key=idempotency_key,
            )
