        ...
        return WorkflowRunResponse.model_validate(
            {
                ...
                "content_mode": values.get("content_mode", "SHORT_STORY"),
                "target_chapter_count": values.get("target_chapter_count", 10),
                "target_total_words": values.get("target_total_words", 30_000),
                "chapter_target_words": values.get("chapter_target_words", 1_800),
                "viewpoint": values.get("viewpoint", "THIRD_LIMITED"),
                "style_profile": values.get("style_profile", {}),
                "status": status,
                "current_node": (
                    "human_review"
                    if waiting
